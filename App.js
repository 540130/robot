const jsonData = {
  ...
  // Create a function to generate the HTML for each bot
  ...
  // Create a function to render the bot information in the DOM
  function renderBots() {
  ...
  // Wait for the DOM to load before rendering the bot information
